        ...
        <div class="details">
            ...
            <div style="margin-top: 20px;">
                ...
                <ul style="list-style-type: none; padding-left: 0;">
                    <li style="margin-bottom: 8px;">Yu Wang, <strong>Mojtaba Zarei</strong>, Borzoo Bonakdarpour, Miroslav Pajic, <em>"Probabilistic conformance for cyber-physical systems,"</em> ACM/IEEE ICCPS, 2021.</li>
                    ...
                    <li style="margin-bottom: 8px;">Yu Wang, <strong>Mojtaba Zarei</strong>, Borzoo Bonakdarpour, Miroslav Pajic, <em>"Statistical verification of hyperproperties for cyber-physical systems,"</em> ACM Transactions on Embedded Computing Systems (Best Paper Finalist), 2019.</li>
                </ul>
            </div>
        </div>
    </div>
